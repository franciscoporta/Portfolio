...
const Inicio = () => {
  return (
    <section id='inicio' className='h-screen bg-[#10101a]'>
        <div className='w-[100%] flex'>
            <div className='w-[50%]'>
                <h1 className='text-white tracking-wider text-6xl mt-[30%] ml-[15%] font-normal'>Francisco Porta</h1>
                <h1 className='text-white tracking-wider text-5xl ml-[17%] mt-[1%] pt-[1%] font-bold'><TypingAnimation/></h1>
                <h1 className='text-white w-[60%] ml-[20%] mt-[3%]'>
                ...
                <button className="p-6 shadow-xl shadow-gray-400 rounded-xl hover:scale-105 ease-in duration-300 mt-[15%] ml-[30%]"><p className='text-white'>Descarga mi CV!</p></button>
            </div>
            <div>
